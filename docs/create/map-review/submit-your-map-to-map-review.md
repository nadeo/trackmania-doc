...
You may submit your own maps to Map Review to gain feedback and ratings from other players. Maps uploaded to Map Review may be chosen as **Tracks of the Day**, **Weekly Shorts** and **Weekly Grands**.
...
![Create Menu confirmation](../../img/mapReviewUpdate_Submit_Menu.png)
...
![Track Editor Live Test](../../img/mapReviewUpdate_Submit_Editor.png)